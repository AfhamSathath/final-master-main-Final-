...
const CompanyJobsPage: React.FC = () => {
  ...
  const createMutation = useMutation<Job, Error, NewJob>({
    ...
    onSuccess: () => {
      ...
      setFormData({ title: "", description: "", company: companyName });
      setShowForm(false);
    },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredJobs.map((job) => (
            ...
            >
              ...
              <p className="text-gray-600 mb-2">Company Name:{job.company}</p>
              <p className="text-gray-700 mb-1">Qualification: {job.qualification}</p><br></br>
              <p className="text-gray-500 mb-2">Open Date: {job.openDate}</p><br></br>
              <p className="text-gray-500 mb-2">Close Date: {job.closeDate }</p><br></br>
              <p className="text-gray-700 text-sm mb-4">Description:{job.description }</p>
