...
const COMPANY_API = "http://localhost:5000/api/companies"; // Endpoint to fetch registered companies
          ...
          >
            ...
            <div className="flex flex-col gap-2 mb-4">
              ...
              <span className="inline-block bg-yellow-100 text-yellow-800 px-2 py-1 rounded-lg text-sm font-medium">
                Open Date: {job.openDate ? new Date(job.openDate).toLocaleDateString() : "N/A"} <br />
            ...
            <div className="flex gap-2 mt-4">
              <button
                className="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition flex items-center gap-1"
                onClick={() => {
                  setEditingJob(job);
                  setFormData({
                    title: job.title,
              ...
              <button
                className="bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 transition flex items-center gap-1"
