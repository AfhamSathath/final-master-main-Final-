...
const UserDashboard: React.FC = () => {
  ...
  const handleProfilePicUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      setUploading(true);
      const res = await axios.post(`${API_BASE}/api/upload/profile`, form, {
        headers: {
      ...
      setUserState({ ...user, profilePic: res.data.url });
    } catch (err) {
        ...
        <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="shadow-md hover:shadow-lg transition-shadow border-l-4 border-blue-500">
              ...
              <CardContent className="pt-6">
                <p className="text-gray-700 mb-4">
                  Browse and enroll in career development courses to enhance your skills.
                </p>
                <Button
            ...
            <Card className="shadow-md hover:shadow-lg transition-shadow border-l-4 border-green-500">
              ...
              <CardContent className="pt-6">
                <p className="text-gray-700 mb-4">
                  Explore job opportunities that match your skills and aspirations.
                </p>
                <Button
