...
import User from "../models/User.js"; // ✅ Import user model too
  ...
  try {
    ...
    if (checkDuplicate) {
      ...
      const existingCompany = await Company.findOne({
        $or: [{ name }, { email }, { regNumber }, { contactNumber: phone }],
      });

      // Check duplicates in User collection too (shared email/phone)
